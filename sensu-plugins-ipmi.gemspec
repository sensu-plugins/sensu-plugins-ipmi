...
<<<<<<< HEAD
  ...
  s.description            = 'Sensu plugins for IPMI'
=======
  s.name                   = 'sensu-plugins-ipmi'
  s.version                = SensuPluginsIpmi::VERSION
  s.authors                = ['Sensu Plugins and contributors']
>>>>>>> update repo
  s.email                  = '<sensu-users@googlegroups.com>'
  s.executables            = s.files.grep(%r{^bin/}) { |f| File.basename(f) }
  s.files                  = Dir.glob('{bin,lib}/**/*') + %w(LICENSE README.md CHANGELOG.md)
  s.homepage               = 'https://github.com/sensu-plugins/sensu-plugins-ipmi'
  s.license                = 'MIT'
<<<<<<< HEAD
  ...
  s.summary                = 'Sensu plugins for IPMI'
